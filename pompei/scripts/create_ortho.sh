...
python ${scripts_dir}/create_orthos_OIS_Reech.py --ta_xml TA_xml_updated.xml --mnt metadata/mnt/mnt.vrt --ori Ori-TerrainFinal_10_10_0.5_AllFree_Final --cpu ${CPU}
...
python ${scripts_dir}/create_big_Ortho.py --ta_xml TA_xml_updated.xml --ori Ori-TerrainFinal_10_10_0.5_AllFree_Final --cpu ${CPU} --mnt metadata/mnt/mnt.vrt

...
def lecture_xml(path):
    ...
    if nb_vol == 0:
        ...
        logger.warning(f"Le chantier a été acquis en {nb_vol+1} vols. Pompei ne fonctionne qu'avec un seul vol. Supprimez les images pour n'avoir plus qu'un seul vol")

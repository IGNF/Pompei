...
for i in `cat liste_tile.txt` ; do
    ...
    ${scripts_dir}/POMPEI.LINUX SousechOri ${nomdalle}.ori 10 ${nomdalle}.ssech10.ori
...
${scripts_dir}/POMPEI.LINUX ReprojTerrain resultpif Orthophotomosaic.ori Orthophotomosaic.ori resultpifreproj

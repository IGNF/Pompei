...
parser = argparse.ArgumentParser(description="Script permettant de créer les fichiers ori pour la recherche de points d'appuis avec pompei_rapide.")
...
Comme les imagettes ne sont pas forcément bien à l'horizontale (contrairement à pompei.sh où l'on utilise l'ortho précalculée), 

...
python ${scripts_dir}/pompei_rapide/create_one_ortho_per_image.py --metadata metadata --ta_xml ${TA} --factor 10 --workdir appuisSousEch10 --decalage False
...
python ${scripts_dir}/pompei_rapide/reproj_appuis.py --factor 10 --regroupe False

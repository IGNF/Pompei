...
if test "$#" = 0; then
    echo "hiatus_after_convert_jp2_to_tif.sh : permet de reprendre Hiatus après la conversion des images numérisées de jp2 à tiff. Permet notamment de changer les paramètres pour la détection des repères de fond de chambre"

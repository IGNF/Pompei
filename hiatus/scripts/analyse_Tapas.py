...
parser.add_argument('--input_rapport', help='Rapport Tapas')
parser.add_argument('--repertoire_scripts', help='Rapport Tapas')
...
def find_problem(chemin_rapport, chemin_scripts):
    ...
    if Recommencer_Tapas:        
        ...
        os.system("rm -r rapports/rapport_Tapas.txt")
        os.system("mm3d Martini \"OIS-Reech_.*tif\" OriCalib=CalibNum >> logfile")
        os.system("mm3d Tapas FraserBasic \"OIS-Reech_.*tif\" InOri=MartiniCalibNum InCal=CalibNum Out=Rel @ExitOnWarn | tee rapports/rapport_Tapas.txt >> logfile")
        os.system("python {}/analyse_Tapas.py --input_rapport rapports/rapport_Tapas.txt --repertoire_scripts {}".format(chemin_scripts, chemin_scripts))
...
if __name__ == "__main__":
    ...
    find_problem(args.input_rapport, args.repertoire_scripts)
    print("")

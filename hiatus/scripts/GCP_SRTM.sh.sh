...
if test -f ../Ortho-MEC-Malt-Abs-Ratafia/Orthophotomosaic_Tile_0_0.tif; then
    ${scripts_dir}/HIATUS.LINUX Reproj resultpt bidon bidon Orthophotomosaic_Tile_0_0.ori Orthophotomosaic_Tile_0_0.ori resultpi >> logfile
    ${scripts_dir}/RANSAC resultpi resultpif --taille_case 5000 > /dev/null >> logfile
    #On reprojette en terrain
    ${scripts_dir}/HIATUS.LINUX ReprojTerrain resultpif Orthophotomosaic_Tile_0_0.ori Orthophotomosaic_Tile_0_0.ori resultpifreproj >> logfile
else
    ${scripts_dir}/HIATUS.LINUX Reproj resultpt bidon bidon Orthophotomosaic_Tile.ori Orthophotomosaic_Tile.ori resultpi >> logfile
    ${scripts_dir}/RANSAC resultpi resultpif --taille_case 5000 > /dev/null >> logfile
    #On reprojette en terrain
    ${scripts_dir}/HIATUS.LINUX ReprojTerrain resultpif Orthophotomosaic_Tile.ori Orthophotomosaic_Tile.ori resultpifreproj >> logfile
fi
...
parser.add_argument('--input_appuis', help='Fichier appuis.xml')
parser.add_argument('--etape', help='1 ou 10')
parser.add_argument('--scripts', help='répertoire contenant les scripts')
parser.add_argument('--pt_appuis_filtres', help='pt_appuis_filtres')
...
def calcul_erreur_moyenne(chemin_geojson, planimetrie, resolution):
    ...
    if erreur_moyenne_plani_pixel > 50 and args.etape=="1":
        ...
        os.system("sh {0}/aeroSousEch10.sh {0} {1}".format(args.scripts, args.pt_appuis_filtres))
...
if __name__ == "__main__":
    ...
    calcul_erreur_moyenne(args.input_geojson, planimetrie, resolution)

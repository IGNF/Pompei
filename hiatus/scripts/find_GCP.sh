...
echo -n "${scripts_dir}/HIATUS.LINUX DecalageDalle:CropResult dallage/${i}.ori ../TraitementAPPssech10/resultpi dallage/${i}.pregeoref 5000 ; " >> bashtmp ;
...
echo -n "${scripts_dir}/HIATUS.LINUX DecalageDalle:FromSim dallage/${i}.ori dallage/${i}.pregeoref_modsim > dallage/${i}.T.txt ; " >> bashtmp ;
echo -n "${scripts_dir}/HIATUS.LINUX TranslatOri:m dallage/${i}.ori dallage/${i}.T.txt dallage/${i}.decal.ori ; " >> bashtmp ;

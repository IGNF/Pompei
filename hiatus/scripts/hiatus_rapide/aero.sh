...
for image in `cat images.txt` ; do
    ...
    python ${scripts_dir}/hiatus_rapide/analyse_campari.py --appuis GCP.xml --report_residuals ${image}_0.txt
    ...
    python ${scripts_dir}/hiatus_rapide/analyse_campari.py --appuis GCP.xml --report_residuals ${image}_1.txt
done

# On fait une moyenne de tous les paramètres de calibration interne trouvés
python ${scripts_dir}/hiatus_rapide/compute_mean_calib.py
...
python ${scripts_dir}/hiatus_rapide/get_best_aero.py 

...
def get_masque(masque, coordsMNSHisto, coordsChantier):
    ...
    #On ouvre le masque
    masque_array, coords_masque = openOrtho(masque)
...
def appliquer_masque():
    ...
    for i in range(len(liste_MNS_histo)):
        ...
        orthoHisto, coordsOrthoHisto = openOrtho(os.path.join(orthoHistoPath, OrthoHistoFile))
        ...
        masque_array = get_masque(masque, coordsOrthoHisto, coordsChantier)
